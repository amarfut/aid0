#pragma checksum "C:\Users\omarf\Desktop\site\Web\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "03d33ed37888af00a80dfdfae1c38679dd03b266"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"03d33ed37888af00a80dfdfae1c38679dd03b266", @"/Views/Home/Index.cshtml")]
...
<script>
    ...
    class Post {
        constructor(title, imageUrl, postUrl, viewsCount, comment");
            WriteLiteral(@"sCount, likesCount, dislikesCount) {
            this.title = title;
        ...
        self.addPosts = function () {
            ...
            $.get('https://localhost:5001/home/loadposts?skip=' + skip, function (posts) {
                ...
                for (let post of posts) {
                  ");
            WriteLiteral(@"  let imageUrl = 'https://storage.cloud.google.com/youit/' + post.url + '/thumbnail.png';
                    let postUrl = 'https://localhost:5001/home/post?url=' + post.url;
