#pragma checksum "C:\Users\omarf\Desktop\site\Web\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c5d19516d4b0123716da21e350b036cc7f55f09a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c5d19516d4b0123716da21e350b036cc7f55f09a", @"/Views/Home/Index.cshtml")]
...
<script>
    ...
    ");
        ...
        constructor(id, title, postUrl, viewsCount, commentsCount, likesCount, dislikesCount) {
            ...
            this.postUrl = 'https://localhost:5001/home/post?url=' + postUrl;
        }
    }
    ...
    function AppViewModel() {
        ...
        self.se");
            WriteLiteral(@"tReaction = function (postId, liked) {
            $.ajax({
   ...
   ");
            WriteLiteral(@"                 self.posts.push(new Post(post.id, post.title, post.url, post.viewsCount, post.commentsCount, post.likesCount, post.dislikesCount));
                }
            });
        };
