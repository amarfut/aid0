...
namespace DataAccess
{
    public class UserRepositoryWrite
    {
        ...
        public async Task<User> CreateUserAsync(string externalId, string name, string provider)
        {
            ...
            return await _context.Users.Find(u => u.ExternalId == externalId).FirstOrDefaultAsync();
        }
